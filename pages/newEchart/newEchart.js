...
Page({
    ...
    UserQuery(e) {
        ...
        data.type = e;
        utils.AjaxRequest(app.globalData.apiurl + "CouponView/CouponGroupView/GeChannelUserCount", "POST", data, app.globalData.appkeyid, this.GetNewUserCount)
    },
    GetNewUserCount(res) {
        let that = this;
        ...
        that.setData({ option: option, xAxisdataList: json.xAxisdataList })
