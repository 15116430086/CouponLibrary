...
Page({
  ...
  RegCouponGroup: function (data) {
    ...
    data = {
      coupon_Group: utils.syJsonSafe(data),
    }
    utils.AjaxRequest(app.globalData.apiurl + "CouponView/CouponGroupView/ModifyGroupInfo", "POST", data, app.globalData.appkeyid, that.RegCouponGroupBack)
